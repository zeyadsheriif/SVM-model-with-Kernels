...
d1 = pd.read_csv("/content/Aggregation.txt",delimiter='\t',skiprows=7)

columns = ["x1", 'x2', 'y']
d1.columns = columns

d1.y.value_counts().plot(kind= 'bar');
...
def plot_decision_regions(X, y, clf):
    ...
    unclassified_points = np.logical_and.reduce([mesh_predictions != cls for cls in unique_classes])
